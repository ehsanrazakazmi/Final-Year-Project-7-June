...
<div class="messenger">
    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : ''); ?>">
        ...
        <div class="m-header">
            <nav>
                <img class="logo" src="<?php echo e(asset('images/ali_logo.PNG')); ?>" alt="logo N/A" width="100px">
                <a href="#"><span class="messenger-headTitle" >GBSP Chatting System</span> </a>
...
<?php /**PATH C:\xampp\htdocs\FYP-7-6-2023\resources\views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>
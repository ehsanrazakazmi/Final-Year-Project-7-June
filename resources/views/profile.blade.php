...
@section('content')
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('{{ asset('assets/img/curved-images/module0.png') }}'); background-position-y: 50%;">
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-4"  style="width: 100%; max-width: 1200px;">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <p class="text-sm">
                I am,  {{Auth::user()->name}} , my task is to give a gateway between both resident and technician tasks that they will perform 
              </p>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Admin registered at: </strong> &nbsp;  {{Auth::user()->email_verified_at}}</li>
